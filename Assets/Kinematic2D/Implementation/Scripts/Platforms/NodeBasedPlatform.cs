...
public class NodeBasedPlatform : KinematicPlatform
{
	...
	protected override void UpdateBehaviour( ref Vector3 position , ref Quaternion rotation , float dt )
    {
		...
		switch(actionState)
		{
			...
			case ActionState.Working:
				...
				{
					if( move )
						CalculatePosition( ref position );
	...
	void CalculatePosition( ref Vector3 position )
	{	
	...
	void CalculateRotation( ref Quaternion rotation )
	{		
		...
		rotation = Quaternion.Euler( finalAngle );
