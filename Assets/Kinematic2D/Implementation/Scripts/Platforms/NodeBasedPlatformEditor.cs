...
[CustomEditor(typeof(NodeBasedPlatform) , true ) , CanEditMultipleObjects ]
public class NodeBasedPlatformEditor : Editor
{
	...
	SerializedProperty useCollisionDetection = null;
	SerializedProperty charactersLayerMask = null;
	...
	void OnEnable()
	{
		...
		charactersLayerMask = serializedObject.FindProperty( "charactersLayerMask" );
	...
	public override void OnInspectorGUI()
	{
		...
		EditorGUILayout.PropertyField( charactersLayerMask );
