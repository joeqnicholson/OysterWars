...
public static class CustomUtilities
{
	...
	public static void RotateAround( ref Vector3 position , ref Quaternion rotation , Vector3 pivot, Vector3 axis, float angle  , bool rotation2D = false )
	{
		if( rotation2D )
			pivot.z = position.z;
		...
		// Debug.DrawLine( initial , position );
	...
	// --- Used for older versions of Unity, deprecated now! --- //
